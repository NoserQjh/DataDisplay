$.getJSON('Js/NumberOfPublication.json', function (data) {
...
$.getJSON('Js/NameOfMolecuarBiology.json', function (data) {
...
$.getJSON('Js/MolecularBiologyRelatedIst.json', function (data) {
